...
import { View, Button, Image, Alert, Text, TouchableOpacity, TextInput, StyleSheet, KeyboardAvoidingView, Platform } from 'react-native';
        ...
        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
          <TouchableOpacity onPress={pickImageAsync}>
            ...
            {selectedImage ? "" : <View style={{ borderWidth: 2, borderColor: 'grey', width: "100%", height: 100, alignItems: 'center', justifyContent: 'center' }}>
              <Text style={{ color: '#ABA944' }}>Upload Event Post</Text>
            </View>}
          </TouchableOpacity >
          <View>
...
const styles = StyleSheet.create({
  ...
  button: {
    backgroundColor: '#2F3CAA', // Orange shade
    padding: 10,
    borderRadius: 5,
    alignItems: 'center',
  },
